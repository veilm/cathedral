# Memory Consolidation: Create Operation
...
You've already planned how to organize this consolidation. Now you're executing one specific create operation from that plan.
...
## Your Task: Create This Memory Node

Based on your plan and the new experience, create this memory node from scratch. This is a new file that will capture part of your recent experience.

## Output Format

Wrap your complete memory node content in `<content>` tags:

```
<content>
# Title of Memory Node

Your complete markdown content here...
</content>
```

The content inside the tags should begin with a markdown header (usually `#` for the title) and continue with the full article.

## Guidelines

- Stay true to your plan - this operation has a specific purpose that was reasoned through carefully
- Create approximately __WORDS__ words of content as planned
- This is a new node, so you're starting fresh - let the structure emerge naturally from the content
